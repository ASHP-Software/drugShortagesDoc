...
* **affectedProduct** - List of prodcuts affected by this drug shortage. Affected products are the actual product on shortage (at the NDC (package size) level).
  ...
  * **lastChangeDate**: Int? - Time stamp in Linux epoch in milliseconds on when this product was last updated. (This field is a recent enhacement and not available for all drug shortage bulletins)
